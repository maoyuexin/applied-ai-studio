...
**Project:** Applied AI Studio
**Generated:** 2026-08-05 12:22:41
...
### Color Palette - OGE-derived workbench

| Role | Hex | CSS Variable |
|------|-----|--------------|
| Primary | `#E8913C` | `--color-primary` |
| On Primary | `#16120E` | `--color-on-primary` |
| Secondary | `#7EAEB8` | `--color-secondary` |
| Accent/CTA | `#E8913C` | `--color-accent` |
| Background | `#111318` | `--color-background` |
| Foreground | `#F5F3F0` | `--color-foreground` |
| Muted | `#9396A6` | `--color-muted` |
| Border | `#2E3140` | `--color-border` |
| Destructive | `#E45A58` | `--color-destructive` |
| Ring | `#E8913C` | `--color-ring` |

**Color Notes:** Reuse OGE's graphite, orange, and steel visual language; retain red, amber, pink, and green only for semantic contrast.
...
- **Mood:** adult technical course, industrial, precise, operational
