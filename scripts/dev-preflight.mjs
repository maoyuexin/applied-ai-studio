...
If you cannot find the original terminal in Codespaces, use the command palette:
Terminal: Kill All Terminals. Then open a new terminal and run npm run dev once.
`);
  process.exitCode = 1;
}