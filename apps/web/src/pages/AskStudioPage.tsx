  ...
  const sendPrompt = async (prompt: string) => {
    ...
    try {
      ...
      if (!controller.signal.aborted) {
        ...
        setError(
          "Ask Studio needs GitHub Copilot on your GitHub account, and your account does not have it yet. There is nothing to install or sign in to — once your Student Developer Pack is approved, this page starts working on its own. Approval usually takes a few days. Everything else works in the meantime: the workflows, the AI Fit Analyzer, and the Online Order demo.",
        );
      }
    } finally {
      setStreaming(false);
